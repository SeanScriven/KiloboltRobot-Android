...
public class Enemy {
    ...
    //create reference to bg1 object in GameScreen so when that moves the enemy moves
    ...
    public void update() {
        follow();
        centerX += speedX;
        //speed is 5 times that of background
    ...
    /*
     * Checks to see if enemy character collides with robot
     */
