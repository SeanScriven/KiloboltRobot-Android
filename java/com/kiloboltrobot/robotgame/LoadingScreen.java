...
/*
 * As long as it takes to load these assets, the game will call the paint() method,
 * in which it draws the splash screen image loaded in the previous screen
 */
public class LoadingScreen extends Screen {
    ...
    public void update(float deltaTime) {
        ...
        //Once loading is complete, the MainMenuScreen opens
